...
const Polityka = () => {
  ...
  <PageLayout>
	...
	<ol>
	<li>Niniejsza polityka dotyczy Serwisu www, funkcjonującego pod adresem url: <b>web.figaro.pl</b></li>
	<li>Operatorem serwisu oraz Administratorem danych osobowych jest: Figaro Corporation ul. Warszawska 10, 08-500 Ryki</li>
	
	<li>Adres kontaktowy poczty elektronicznej operatora: ryki@figaro.pl</li>
	...
	<ul><li>Obsługa zapytań przez formularz</li><li>Realizacja zamówionych usług</li><li>Prezentacja oferty lub informacji</li>
	</ul>
